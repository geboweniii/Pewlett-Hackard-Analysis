...
--Create new table containing only the current employees who are eligible for retirement will be returned
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
-- Create table of employee counts in departments
SELECT COUNT(ce.emp_no), de.dept_no
...
--Create table of employee info with gender and salary, etc
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
...
--Create table of list of managers per department
...
--CReate table of depatrtment retirees
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name
